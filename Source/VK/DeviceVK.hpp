...
static constexpr VkImageUsageFlags GetImageUsageFlags(TextureUsageBits textureUsageBits) {
    ...
    if (textureUsageBits & TextureUsageBits::VIDEO_DECODE_REFERENCE_ONLY)
    ...
    if (textureUsageBits & TextureUsageBits::VIDEO_ENCODE_REFERENCE_ONLY)
...
void DeviceVK::FillCreateInfo(const TextureDesc& textureDesc, VkImageCreateInfo& info) const {
    ...
    if (textureDesc.usage & (TextureUsageBits::VIDEO_DECODE | TextureUsageBits::VIDEO_ENCODE | TextureUsageBits::VIDEO_DECODE_REFERENCE_ONLY | TextureUsageBits::VIDEO_ENCODE_REFERENCE_ONLY))
